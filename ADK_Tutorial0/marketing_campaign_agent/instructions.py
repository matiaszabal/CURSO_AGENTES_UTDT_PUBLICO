# Instrucción del agente 1: investiga el producto con google_search
...
# Instrucción del agente 2: lee el resultado del anterior desde el estado
# (state['market_research_summary']) y define el mensaje central de la campaña
...
# Instrucción del agente 3: lee state['key_messaging'] y escribe variantes de ad copy
...
# Instrucción del agente 4: lee state['ad_copy_variations'] y sugiere conceptos visuales
...
# Instrucción del agente 5: el único que lee VARIOS keys del estado a la vez
# (los 4 resultados anteriores) para armar el brief final en Markdown
...
# Descripción del SequentialAgent orquestador (no es la instrucción de un LLM,
# es metadata: aparece en el grafo/documentación de adk web)
